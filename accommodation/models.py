...
class Accommodation(models.Model):
    ...
    nb_t1_available = models.IntegerField(null=True, blank=True)
    nb_t1_bis = models.IntegerField(null=True, blank=True)
    nb_t1_bis_available = models.IntegerField(null=True, blank=True)
    nb_t2 = models.IntegerField(null=True, blank=True)
    nb_t2_available = models.IntegerField(null=True, blank=True)
    nb_t3 = models.IntegerField(null=True, blank=True)
    nb_t3_available = models.IntegerField(null=True, blank=True)
    nb_t4_more = models.IntegerField(null=True, blank=True)
    nb_t4_more_available = models.IntegerField(null=True, blank=True)
