...
DOSSIERFACILE_FRONTEND_SUCCESS_URL = env("DOSSIERFACILE_FRONTEND_SUCCESS_URL", default="")
DOSSIERFACILE_FRONTEND_ERROR_URL = env("DOSSIERFACILE_FRONTEND_ERROR_URL", default="")


# FAC HABITAT SFTP settings
FAC_HABITAT_SFTP_HOST = env("FAC_HABITAT_SFTP_HOST", default="")
FAC_HABITAT_SFTP_USERNAME = env("FAC_HABITAT_SFTP_USERNAME", default="")
FAC_HABITAT_SFTP_PORT = env.int("FAC_HABITAT_SFTP_PORT", default=22)
FAC_HABITAT_SFTP_PASSWORD = env("FAC_HABITAT_SFTP_PASSWORD", default="")
FAC_HABITAT_SFTP_PRIVATE_KEY_PATH = env("FAC_HABITAT_SFTP_PRIVATE_KEY_PATH", default="")
FAC_HABITAT_SFTP_HOST_KEY_SHA256 = env("FAC_HABITAT_SFTP_HOST_KEY_SHA256", default="")
